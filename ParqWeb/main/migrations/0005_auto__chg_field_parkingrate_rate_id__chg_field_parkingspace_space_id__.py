...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Parkingrate.rate_id'
        db.alter_column(u'parkingrate', 'rate_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Parkingspace.space_id'
        db.alter_column(u'parkingspace', 'space_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Adminrole.adminrole_id'
        db.alter_column(u'adminrole', 'adminrole_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Userrole.userrole_id'
        db.alter_column(u'userrole', 'userrole_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Parkinglocation.location_id'
        db.alter_column(u'parkinglocation', 'location_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Userclientrelationship.uc_rel_id'
        db.alter_column(u'userclientrelationship', 'uc_rel_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Admin.admin_id'
        db.alter_column(u'admin', 'admin_id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='admin_id'))

        # Changing field 'Adminclientrelationship.ac_rel_id'
        db.alter_column(u'adminclientrelationship', 'ac_rel_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Parkinginstance.parkinginst_id'
        db.alter_column(u'parkinginstance', 'parkinginst_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'User.user_id'
        db.alter_column(u'user', 'user_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Payment.payment_id'
        db.alter_column(u'payment', 'payment_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Client.client_id'
        db.alter_column(u'client', 'client_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

        # Changing field 'Geolocation.geolocation_id'
        db.alter_column(u'geolocation', 'geolocation_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Parkingrate.rate_id'
        db.alter_column(u'parkingrate', 'rate_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Parkingspace.space_id'
        db.alter_column(u'parkingspace', 'space_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Adminrole.adminrole_id'
        db.alter_column(u'adminrole', 'adminrole_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Userrole.userrole_id'
        db.alter_column(u'userrole', 'userrole_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Parkinglocation.location_id'
        db.alter_column(u'parkinglocation', 'location_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Userclientrelationship.uc_rel_id'
        db.alter_column(u'userclientrelationship', 'uc_rel_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Admin.admin_id'
        db.alter_column(u'admin', 'admin_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_column='admin_id'))

        # Changing field 'Adminclientrelationship.ac_rel_id'
        db.alter_column(u'adminclientrelationship', 'ac_rel_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Parkinginstance.parkinginst_id'
        db.alter_column(u'parkinginstance', 'parkinginst_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'User.user_id'
        db.alter_column(u'user', 'user_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Payment.payment_id'
        db.alter_column(u'payment', 'payment_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Client.client_id'
        db.alter_column(u'client', 'client_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

        # Changing field 'Geolocation.geolocation_id'
        db.alter_column(u'geolocation', 'geolocation_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
    ...
    models = {
        ...
        'main.admin': {
            ...
            'admin_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'db_column': "'admin_id'"}),
        ...
        'main.adminclientrelationship': {
            ...
            'ac_rel_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'admin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'client_relationships'", 'to': "orm['main.Admin']"}),
            'adminrole': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relationships'", 'to': "orm['main.Adminrole']"}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'admin_relationships'", 'to': "orm['main.Client']"}),
            'lastupdatedatetime': ('django.db.models.fields.DateTimeField', [], {})
        },
        'main.adminrole': {
            'Meta': {'object_name': 'Adminrole', 'db_table': "u'adminrole'"},
            'adminrole_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdatedatetime': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'main.geolocation': {
            ...
            'geolocation_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastupdatedatetime': ('django.db.models.fields.DateTimeField', [], {}),
            'latitude': ('django.db.models.fields.FloatField', [], {}),
            'location': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'geolocation'", 'unique': 'True', 'to': "orm['main.Parkinglocation']"}),
        ...
        'main.parkinginstance': {
            ...
            'parkinginst_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'main.parkingrate': {
            ...
            'rate_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'main.parkingspace': {
            ...
            'space_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'main.userclientrelationship': {
            ...
            'uc_rel_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'main.userrole': {
            ...
            'role_desc': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'role_name': ('django.db.models.fields.TextField', [], {}),
            'userrole_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
