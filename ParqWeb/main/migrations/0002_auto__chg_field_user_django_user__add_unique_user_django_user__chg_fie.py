...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.django_user'
        db.alter_column(u'user', 'django_user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))

        # Adding unique constraint on 'User', fields ['django_user']
        db.create_unique(u'user', ['django_user_id'])

        # Changing field 'Payment.parkinginst'
        db.alter_column(u'payment', 'parkinginst_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['main.Parkinginstance']))

        # Adding unique constraint on 'Payment', fields ['parkinginst']
        db.create_unique(u'payment', ['parkinginst_id'])

        # Changing field 'Paymentaccount.account_id'
        db.alter_column(u'paymentaccount', 'account_id', self.gf('django.db.models.fields.AutoField')(primary_key=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Payment', fields ['parkinginst']
        db.delete_unique(u'payment', ['parkinginst_id'])

        # Removing unique constraint on 'User', fields ['django_user']
        db.delete_unique(u'user', ['django_user_id'])

        # Changing field 'User.django_user'
        db.alter_column(u'user', 'django_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Payment.parkinginst'
        db.alter_column(u'payment', 'parkinginst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Parkinginstance']))

        # Changing field 'Paymentaccount.account_id'
        db.alter_column(u'paymentaccount', 'account_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
    ...
    models = {
        ...
        'main.paymentaccount': {
            ...
            'account_id': ('django.db.models.fields.AutoField', [], {'default': '-1', 'primary_key': 'True'}),
