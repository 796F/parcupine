...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Geolocation.location'
        db.alter_column(u'geolocation', 'location_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['main.Parkinglocation']))

        # Adding unique constraint on 'Geolocation', fields ['location']
        db.create_unique(u'geolocation', ['location_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Geolocation', fields ['location']
        db.delete_unique(u'geolocation', ['location_id'])

        # Changing field 'Geolocation.location'
        db.alter_column(u'geolocation', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Parkinglocation']))
