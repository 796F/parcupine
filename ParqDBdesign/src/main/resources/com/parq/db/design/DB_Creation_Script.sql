...
(space_id BIGINT NOT NULL AUTO_INCREMENT,
 ...
 latitude DOUBLE NOT NULL,
 longitude DOUBLE NOT NULL,
 segment BIGINT NOT NULL DEFAULT 999000,
 is_deleted BOOLEAN DEFAULT FALSE,
 lastupdatedatetime TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, 
...
(report_id BIGINT NOT NULL AUTO_INCREMENT,
 ...
 space1_id BIGINT,
 space1_status TEXT(16),
 score1 BIGINT DEFAULT 0,
 space2_id BIGINT,
 space2_status TEXT(16),
 score2 BIGINT DEFAULT 0,
 space3_id BIGINT,
 space3_status TEXT(16),
 score3 BIGINT DEFAULT 0,
 space4_id BIGINT,
 space4_status TEXT(16),
 score4 BIGINT DEFAULT 0,
 space5_id BIGINT,
 space5_status TEXT(16),
 score5 BIGINT DEFAULT 0,
 space6_id BIGINT,
 space6_status TEXT(16),
 score6 BIGINT DEFAULT 0,
 PRIMARY KEY (report_id),
 FOREIGN KEY (user_id) references user(user_id),
 FOREIGN KEY (space1_id) references parkingspace(space_id),
 FOREIGN KEY (space2_id) references parkingspace(space_id),
 FOREIGN KEY (space3_id) references parkingspace(space_id),
 FOREIGN KEY (space4_id) references parkingspace(space_id),
 FOREIGN KEY (space5_id) references parkingspace(space_id),
 FOREIGN KEY (space6_id) references parkingspace(space_id));
