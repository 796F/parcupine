...
//{"parkingReferenceNumber":"23:151:1325113034","spotId":151,"durationMinutes":5,"chargeAmount":337,"paymentType":0,"uid":23,"userInfo""email":"xia.umd@gmail.com","password":"aaaaaa"}}
		...
		EditCCRequest pr = new EditCCRequest();
		pr.setAddress("2406 Oakmere Road");
		pr.setCreditCard("5195170016660677");
		pr.setCscNumber("226");
		pr.setExpMonth(4);
		pr.setExpYear(2014);
...
//		pr.setZipcode("19810");
		...
		String outstring = service.path("changeCC").type(MediaType.APPLICATION_JSON).post(String.class, pr);
